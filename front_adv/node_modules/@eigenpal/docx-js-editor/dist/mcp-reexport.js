import {f,l}from'./chunk-PGEORVCG.js';import {a}from'./chunk-AARNCPWR.js';import {n}from'./chunk-3X3LTNK4.js';import {b}from'./chunk-BUEMG4NW.js';import'./chunk-SE5EN2QL.js';import'./chunk-USRMBYI6.js';import'./chunk-H5NTJZO4.js';var u={type:"string",description:"Document ID returned from docx_load"},h={type:"object",properties:{paragraphIndex:{type:"number",description:"Index of the paragraph (0-indexed)",minimum:0},offset:{type:"number",description:"Character offset within the paragraph",minimum:0}},required:["paragraphIndex","offset"]},T={type:"object",properties:{start:h,end:h},required:["start","end"]},D={name:"docx_load",description:`Load a DOCX document from base64-encoded content.
