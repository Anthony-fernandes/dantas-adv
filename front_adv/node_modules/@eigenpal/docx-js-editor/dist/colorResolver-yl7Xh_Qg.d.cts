import { D as Document, d as DocumentBody, C as SectionProperties, A as AgentCommand, h as AgentContext, R as Range, G as SelectionContext, T as TextFormatting, ae as ColorValue, X as Theme, af as ThemeColorSlot, ab as ThemeColorScheme } from './agentApi-DmDuQm0e.cjs';
import { g as DocxInput } from './DocumentAgent-cHf96hwL.cjs';
