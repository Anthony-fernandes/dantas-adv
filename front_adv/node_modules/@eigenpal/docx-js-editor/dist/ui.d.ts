...
declare function AdvancedColorPicker({ mode, value, onChange, theme, disabled, className, style, title, icon: iconOverride, autoLabel, }: AdvancedColorPickerProps): react_jsx_runtime.JSX.Element;
