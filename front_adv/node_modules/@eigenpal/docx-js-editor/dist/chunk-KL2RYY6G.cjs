...
`);return i.length>n?i.slice(0,n)+"...":i}function bt(r,t){let e=0;for(let n of r.content)if(n.type==="run"){let a=k(n),o=e,s=e+a.length;if(t>=o&&t<s)return n.formatting||{};e=s;}else if(n.type==="hyperlink"){let a=v(n),o=e,s=e+a.length;if(t>=o&&t<s){for(let i of n.children)if(i.type==="run")return i.formatting||{}}e=s;}return {}}function Pt(r,t){let e=0;for(let n of r.content)if(n.type==="run"){let a=k(n);e+=a.length;}else if(n.type==="hyperlink"){let a=v(n),o=e,s=e+a.length;if(t>=o&&t<s)return  true;e=s;}return  false}function Ct(r,t,e){let n=[];return r.length>0&&(n.push({id:"rewrite",label:"Rewrite",description:"Rewrite this text",priority:10},{id:"summarize",label:"Summarize",description:"Summarize this text",priority:9}),r.length>200&&n.push({id:"summarize",label:"Summarize",description:"Create a shorter version",priority:8}),r.length<50&&r.split(/\s+/).length<10&&n.push({id:"expand",label:"Expand",description:"Add more details",priority:8}),n.push({id:"fixGrammar",label:"Fix Grammar",description:"Fix grammar and spelling",priority:7}),n.push({id:"translate",label:"Translate",description:"Translate to another language",priority:6}),n.push({id:"makeFormal",label:"Make Formal",description:"Use formal tone",priority:5},{id:"makeCasual",label:"Make Casual",description:"Use casual tone",priority:4})),n.sort((a,o)=>(o.priority||0)-(a.priority||0)),n}function St(r,t,e={}){let{contextCharsBefore:n=200,contextCharsAfter:a=200,includeSuggestions:o=true}=e,s=r.package.document,i=s.content.filter(x=>x.type==="paragraph");if(t.start.paragraphIndex>=i.length)throw new Error(`Invalid start paragraph index: ${t.start.paragraphIndex}`);let c=i[t.start.paragraphIndex],l=At(i,t),u=Tt(i,t.start,n),g=kt(i,t.end,a),f=It(c,t.start.offset),y=c.formatting||{},p={index:t.start.paragraphIndex,fullText:P(c),style:c.formatting?.styleId,wordCount:R(P(c))},m=Dt(s,t.start),b=_t(c,t.start.offset),d=o?Ft(l):[];return {selectedText:l,range:t,formatting:f,paragraphFormatting:y,textBefore:u,textAfter:g,paragraph:p,inTable:m,inHyperlink:b,suggestedActions:d}}function ne(r,t,e={}){let n=St(r,t,e),{includeDocumentSummary:a=true}=e,s=r.package.document.content.filter(p=>p.type==="paragraph"),i=R(n.selectedText),c=n.selectedText.length,l=t.start.paragraphIndex!==t.end.paragraphIndex,u=[];for(let p=t.start.paragraphIndex;p<=t.end.paragraphIndex;p++)u.push(p);let g=vt(s,t),f=a?K(r):void 0,y=Rt(n.selectedText);return {...n,documentSummary:f,wordCount:i,characterCount:c,isMultiParagraph:l,paragraphIndices:u,detectedLanguage:y,contentType:g}}function re(r,t){let n=r.package.document.content.filter(i=>i.type==="paragraph"),a=[];for(let i=t.start.paragraphIndex;i<=t.end.paragraphIndex;i++){let c=n[i];if(!c)continue;let l=i===t.start.paragraphIndex?t.start.offset:0,u=i===t.end.paragraphIndex?t.end.offset:1/0;wt(c,l,u,a);}let o=a.length<=1||a.every(i=>Ht(i,a[0]));return {predominant:a.length>0?a[0]:{},isConsistent:o,allFormatting:a}}function At(r,t){if(t.start.paragraphIndex===t.end.paragraphIndex){let n=r[t.start.paragraphIndex];return n?P(n).slice(t.start.offset,t.end.offset):""}let e=[];for(let n=t.start.paragraphIndex;n<=t.end.paragraphIndex;n++){let a=r[n];if(!a)continue;let o=P(a);n===t.start.paragraphIndex?e.push(o.slice(t.start.offset)):n===t.end.paragraphIndex?e.push(o.slice(0,t.end.offset)):e.push(o);}return e.join(`
`)}function Tt(r,t,e){let n=[],a=0,o=r[t.paragraphIndex];if(o){let c=P(o).slice(0,t.offset);n.unshift(c),a+=c.length;}for(let i=t.paragraphIndex-1;i>=0&&a<e;i--){let c=r[i];if(!c)continue;let l=P(c);n.unshift(l),a+=l.length;}let s=n.join(`
`);return s.length>e?"..."+s.slice(-e):s}function kt(r,t,e){let n=[],a=0,o=r[t.paragraphIndex];if(o){let c=P(o).slice(t.offset);n.push(c),a+=c.length;}for(let i=t.paragraphIndex+1;i<r.length&&a<e;i++){let c=r[i];if(!c)continue;let l=P(c);n.push(l),a+=l.length;}let s=n.join(`
`);return s.length>e?s.slice(0,e)+"...":s}function It(r,t){let e=0;for(let n of r.content)if(n.type==="run"){let a=S(n),o=e+a.length;if(t>=e&&t<o)return n.formatting||{};e=o;}else if(n.type==="hyperlink"){let a=I(n),o=e+a.length;if(t>=e&&t<o){for(let s of n.children)if(s.type==="run")return s.formatting||{}}e=o;}return {}}function wt(r,t,e,n){let a=0;for(let o of r.content)if(o.type==="run"){let s=S(o),i=a,c=a+s.length;c>t&&i<e&&o.formatting&&n.push({...o.formatting}),a=c;}else if(o.type==="hyperlink"){let s=I(o),i=a,c=a+s.length;if(c>t&&i<e)for(let l of o.children)l.type==="run"&&l.formatting&&n.push({...l.formatting});a=c;}}function Dt(r,t){return  false}function _t(r,t){let e=0;for(let n of r.content)if(n.type==="run"){let a=S(n);e+=a.length;}else if(n.type==="hyperlink"){let a=I(n),o=e,s=e+a.length;if(t>=o&&t<s)return  true;e=s;}return  false}function Ft(r,t,e){let n=[];if(!r||r.trim().length===0)return n;n.push({id:"askAI",label:"Ask AI",description:"Ask AI about this text",priority:11},{id:"rewrite",label:"Rewrite",description:"Rewrite this text differently",priority:10});let a=R(r);return a>50&&n.push({id:"summarize",label:"Summarize",description:"Create a shorter version",priority:9}),a<20&&n.push({id:"expand",label:"Expand",description:"Add more details",priority:9}),n.push({id:"fixGrammar",label:"Fix Grammar",description:"Fix grammar and spelling",priority:7},{id:"translate",label:"Translate",description:"Translate to another language",priority:6},{id:"explain",label:"Explain",description:"Explain what this means",priority:5}),n.push({id:"makeFormal",label:"Make Formal",description:"Use formal tone",priority:4},{id:"makeCasual",label:"Make Casual",description:"Use casual tone",priority:3}),n.sort((o,s)=>(s.priority||0)-(o.priority||0)),n}function vt(r,t){let e=new Set;for(let n=t.start.paragraphIndex;n<=t.end.paragraphIndex;n++){let a=r[n];a&&(a.listRendering?e.add("list"):a.formatting?.styleId?.toLowerCase().includes("heading")?e.add("heading"):e.add("prose"));}return e.size>1?"mixed":e.has("list")?"list":e.has("heading")?"heading":"prose"}function Rt(r){return /[а-яА-ЯёЁ]/.test(r)?"ru":/[一-龯]/.test(r)?"zh":/[ひらがなカタカナ]/.test(r)||/[\u3040-\u309F\u30A0-\u30FF]/.test(r)?"ja":/[가-힣]/.test(r)?"ko":/[àâäéèêëïîôùûüç]/i.test(r)?"fr":/[äöüß]/i.test(r)?"de":/[áéíóúñ]/i.test(r)?"es":"en"}function P(r){let t=[];for(let e of r.content)e.type==="run"?t.push(S(e)):e.type==="hyperlink"&&t.push(I(e));return t.join("")}function S(r){return r.content.filter(t=>t.type==="text").map(t=>t.text).join("")}function I(r){let t=[];for(let e of r.children)e.type==="run"&&t.push(S(e));return t.join("")}function R(r){return r.split(/\s+/).filter(t=>t.length>0).length}function Ht(r,t){let e=Object.keys(r),n=Object.keys(t);return e.length!==n.length?false:e.every(a=>{let o=r[a],s=t[a];return o===s})}exports.a=tt;exports.b=Z;exports.c=Y;exports.d=at;exports.e=Wt;exports.f=T;exports.g=Gt;exports.h=Zt;exports.i=ot;exports.j=Qt;exports.k=K;exports.l=St;exports.m=ne;exports.n=re;