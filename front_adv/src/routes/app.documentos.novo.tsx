...
function Novo() {
  ...
  return (
    <div className="mx-auto max-w-[900px] p-6 md:p-8 space-y-6">
      <Link to="/app/documentos" className="inline-flex items-center gap-1.5 text-[12.5px] text-muted-foreground hover:text-foreground">
        <ArrowLeft className="h-3.5 w-3.5" /> Voltar para documentos
      </Link>
      <PageHeader eyebrow="Documentos" title="Novo documento" description="Envie um arquivo e vincule opcionalmente a um processo ou cliente." />
      ...
      <form onSubmit={submit} className="surface-card p-6 space-y-6">
        ...
        <div className="flex items-center justify-end gap-2 pt-4 border-t border-border">
          <Link to="/app/documentos" className="rounded-md border border-border bg-card px-4 py-2 text-[13px] hover:bg-muted">Cancelar</Link>
